...
<link rel="stylesheet" type="text/css" href="skin/css/main.css"><script
	type="text/javascript" src="../servtools/jquery-1.3.2.min.js?v=1.3.2"></script>
...
<table class="form-table">
	...
	<tr>
		...
		<td><input type="text" name="tag_color" style=" background-color:<?php echo $news_info['tag_color']?>;" value="<?php echo $news_info['tag_color']?>" onclick="coloropen(event)" id="inputcolor" />
		<div id="colorpane"
	...
	<tr>
		...
		<td><input type="checkbox" name="is_blod" value="1"
		<?php if ($news_info['is_blod']==1) {echo "checked";}?>></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<iframe name="KindImageIframe" id="KindImageIframe" width="100%"
			height='30' align="top" allowTransparency="true" scrolling="no"
