...
<body >
<iframe id="imall_modules" scrolling="no"  src="modules.php" name="imall_modules" style="width:100%;overflow:hidden;margin:0;padding:0;border:none" frameborder="0" marginwidth="0" marginheight="0" onload="document.getElementById('imall_modules').style.height=imall_modules.document.body.scrollHeight+20+'px'">
